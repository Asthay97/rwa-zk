...
const abi = require("../constants/assetguard-abi.json");
...
export default function Home() {
  ...
  console.log(`The owner of assetguard is ${permissoryOwner}`);
  ...
  return (
    <>
      <Head>
        ...
        <meta name="Permissory" content="assetguard" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      {/* Displaying welcome message or Metamask connection prompt based on Web3 status */}
      <div className={styles.form_label_owner}>Welcome to assetguard</div>
